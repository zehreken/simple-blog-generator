...
I tried a few different models at first, namely Coqui, SpeechT5, and Dia. I chose [SpeechT5](https://huggingface.co/docs/transformers/en/model_doc/speecht5) because the instructions were clearer and the dependencies fewer than the others. But you should check out [Dia's demo](https://yummy-fir-7a4.notion.site/dia), it is incredible.
...
[Go to source](https://github.com/zehreken/finetune-speecht5)
"""